...
const steps = [
  {
    ...
    description: 'Registre-se e personalize seu perfil com nome, ícone e cor favorita.'
  },
  {
...
const comingSoon = [
  ...
  // { icon: 'pi-share-alt', title: 'Compartilhar apostas nas redes sociais' },
  { icon: 'pi-calendar', title: 'Visualização por semana no calendário' }
  // { icon: 'pi-flag', title: 'Ligas privadas entre grupos de amigos' }
];
</script>
...
.cta {
  ...
  border-radius: 12px;
  background: linear-gradient(135deg, var(--bolao-c-navy-t2), var(--bolao-c-navy-t1));
  text-align: center;
